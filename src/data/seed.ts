/** Popular repositório de produtos com alguns itens */
import type { IProductRepository } from '../repositories/InMemoryProductRepository.js'
 ...
 */
export async function seedProducts(repo: IProductRepository): Promise<void> {
  const items: Product[] = [
